// Hoso Studio — ПО ССЫЛКЕ ?share=ID — ВСЁ ТВОЁ: ГАЛЕРЕЯ, ССЫЛКИ, ПОРЯДОК
// ЛОКАЛЬНЫЕ ВИДЕО ПЕРЕДАЮТСЯ В БРАУЗЕР ДРУГА
...
(function(){
  ...
  const shareId = urlParams.get('share') || userId; // КЛЮЧ ДЛЯ ДРУГА
  ...
  shareBtn.onclick = () => {
    ...
    if (navigator.share) {
      ...
      navigator.clipboard.writeText(url).then(() => {
        alert('Ссылка скопирована! Друг увидит твой плейлист — даже видео из галереи.');
